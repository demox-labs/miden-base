...
pub fn create_basic_wallet(
    ...
    web_sys::console::log_1(&"lib 1".into());
    ...
    web_sys::console::log_1(&"lib 2".into());
    ...
    web_sys::console::log_1(&"lib 3".into());
    ...
    web_sys::console::log_1(&"lib 6".into());
